...
parameterSummary = summary(T_modelTR, c("R0","r_lock_1","m_lock_1","m_relax_1","shift_lock_1","gamma_s","gamma_H","gamma_ICU","eps_H_ICU",
                                        "k_epsx","eps_ICU_x","r_d_s","r_d_a"), probs = c(0.025, 0.25, 0.50, 0.75, 0.975))
