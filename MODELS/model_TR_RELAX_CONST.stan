functions {
  ...
  real switch_relax(real t, real t_relax, real r_relax, real m_relax, real shift_relax, real r_end) {
    ...
    int[]  x_i 
      ...
      p_relax_1   = switch_relax(t,trelax_1,r_lock_1,mrelax_1,srelax_1,r_end);
      ...
      // print(t," ",trelax_1," ",r_lock_1," ",mrelax_1," ",srelax_1," ",r_end," ",coeffR)
      // Initial conditions
...
parameters{
  ...
  real<lower=0, upper=0.25> r_lock_1;
...
generated quantities{
  ...
  y_pred = integrate_ode_bdf(
    ...
    for(i in 1:S) {
      ...
      p_relax_1 = switch_relax(i,trelax_1,r_lock_1,mrelax_1,srelax_1,r_end);
